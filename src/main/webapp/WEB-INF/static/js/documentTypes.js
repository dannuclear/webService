...
$(document)
    .ready(
        function () {
            ...
            $('.document-type-table, .document-type-select-table')
                .DataTable(
                    {
                        ajax: {
                            url: '/webService/private/documentTypes/dataTable'
                        },
                        rowId: 'id',
            ...
            $('#document-type-table-dialog').find('#submit-button').on('click', function (e) {
